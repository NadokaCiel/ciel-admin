<template>
  <div class="class-list">
    <div class="page-title">职业列表</div>
    <div class="page-subtitle">Class List</div>
    <div class="tool">
...
export default {
  ...
  methods: {
    ...
    async deleteLine(line) {
      const vm = this;
      vm.$confirm(`确定删除职业：“${line.name}”吗？`, "删除职业", {
